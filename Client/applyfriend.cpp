...
#include <QScrollBar>
#include <QJsonDocument> // todo: 可能需要删除掉
    ...
    ui(new Ui::ApplyFriend),_label_point(2,6)
{
    ...
    this->setModal(true);
    ui->name_ed->setPlaceholderText(tr("TheFool"));
    ui->lb_ed->setPlaceholderText("搜索、添加标签");
    ui->back_ed->setPlaceholderText("The FoolEngine project is currently under development...");
...
void ApplyFriend::SetSearchInfo(std::shared_ptr<SearchInfo> si)
{
    ...
    // auto applyname = si->_name;
    auto bakname = si->_nick;
